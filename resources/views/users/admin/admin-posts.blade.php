<x-layout>
    <nav class="bg-gray-100 md:px-0 px-1">
        <ul class="flex space-x-2 container max-w-md mx-auto py-3 px-2">
            ...
            <li class="flex-1">
                <a class="text-center block rounded py-2 px-4 bg-orange-600 text-white font-bold" href="/admin/posts">Posts</a>
            </li>
            <li class="flex-1">
    ...
    <div class="overflow-x-auto relative container mx-auto">
        <h1 class="text-4xl text-center my-5">Posts</h1>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="py-4 px-6">
                                <div class="flex space-x-1">
                                    <a class="text-white bg-green-500 p-1 rounded-lg hover:bg-green-600" href="/posts/{{ $post->slug }}/edit">Edit</a>
